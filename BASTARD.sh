...
#MALU TOLOL!!!
#KAGA BERMORAL!
#GUA DOA'IN YG COPYRIGHT COPAS RECORD TANPA IDZIN
#BISUL GK SEMBUH SEMBUH.
#AAMIIN
#BIKIN SCRIPT INI PUYENG ANJING
#GAUSAH ASAL RECORDE COPYRIGHT COPAS TANPA IDZIN KE GUA!!
#MASIH MENDING GUA KASIH GRATISAN LU MONYET!
#KALO MAU COPYRIGHT COPAS RECORD EDIT AUTHOR
#IDZIN DULU KE FACEBOOK ADIK GUA!
#MORE INFO DM FACEBOOK : ANISSA SYAH
...
clear
        ...
        echo -e $red [•]" Pasword Benar"
        echo -e $red [•]" SELAMAT :V "
        sleep 3
        echo -e $red [•]" TAPI BOHONG :P"
        sleep 4
        sh BASTARD.sh
        sleep 5
fi
sleep 2
echo "SUBSCRIBE DULU YH KAWAN 🙏" | lolcat
echo "JANGAN SAMPE ENGGA 😔"
echo "HARGAI KARYA KAMI DENGAN CARA"
echo "SUBSCRIBE YOUTUBE KAMI 🙏" | lolcat
sleep 6
...
echo "[•]             O O   ) /    |                                 [•]" | lolcat
echo "[•]             _^__  <     /                                  [•]" | lolcat
echo "[•]            (_)  _  )    /  ==>Please For Dont Recode:)     [•]" | lolcat
echo "[•]             \___/     /                                    [•]" | lolcat
echo "[•]             \_____/ /   ==>Please For Dont Reedit Author:) [•]" | lolcat
echo "[•]<----\     __ / __   \                                      [•]" | lolcat
echo "[•] <--- |====O)))==) \) /====() ==>Gua Puyeng Gblk Buat nya:) [•]" | lolcat
echo "[•]<----/    \__/ \__/   \                                     [•]" | lolcat
echo "[•]                  |     }     ==>Mikir Make Otak :)         [•]" | lolcat
echo "[•]                \       /                                   [•]" | lolcat
echo "[•]         _______( (_  / \______ ==>Dont Forget To Support   [•]" | lolcat
echo "[•]        /  .______/   |        \                            [•]" | lolcat
echo "[•]        '__{__________)        \/                           [•]" | lolcat
echo "[•]TYPE     : TOOLS INSTALLER                                  [•]" | lolcat
echo "[•]VERSION  : V.0                                              [•]" | lolcat
...
ctrl_c() {
clear
echo -b $green"[#]> TOOLS NU SIA INSTALL AYA DI DIRECTORY TOOLS AINK " |lolcat
